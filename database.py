...
c.execute("CREATE TABLE test (id integer, sum_sent_start integer, sum_sent_end integer,sum_sent_seconds integer, sum_sent_bytes integer)")
#c.execute("INSERT INTO test VALUES (1, 2, 3, 4, 5)")
c.execute('insert into test (id, sum_sent_start, sum_sent_end, sum_sent_seconds, sum_sent_bytes) values (?, ?, ?, ?, ?)',
			(1, 
